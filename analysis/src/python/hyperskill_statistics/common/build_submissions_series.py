...
def build_submissions_series(submissions_path: str = '../data/java/submissions_with_issues_java11.csv',
    ...
    df_submission_series = df_submissions \
        .groupby([SubmissionColumns.USER_ID, SubmissionColumns.STEP_ID], as_index=False) \
        .parallel_apply(lambda g: preprocess_solutions(g)) \
        .agg(list)
